        ...
        <div className="container">
          <div className="row justify-content-between align-items-center">
            ...
            <div className="col-lg-6 mb-5 mb-lg-0 text-center">
              <img
                style={{ width: "100%" }}
                src="./assets/img/intro/img-woman-1.jpg"alt="#"
              />
            </div>
          </div>
        </div>
          ...
          <div class="enterprise-box">
            <div class="row">
              <div class="col-lg-4 col-sm-12">
                <div class="resource-box">
                  <div className="resource_text">
                    <img src="assets/img/services/4.svg" className="match-img"alt="#" />
                    <h1 className="box_text">Mission</h1>
                  </div>
                  <p className="muted_text">
                    To provide excellent services in the field of
                    Finance,Taxation,Agriculture, Investment and Advisory to
                    enhance wealth. Thereafter, boosting the career
              ...
              <div class="col-lg-4 col-sm-12">
                <div class="resource-box">
                  <div className="resource_text">
                    <img src="assets/img/services/6.svg" className="match-img"alt="#" />

                    <h1 className="box_text">Vision</h1>
                  </div>
                  <p className="muted_text">
                    Integrity.Honesty.Transparency.Trustworthiness.
              ...
              <div class="col-lg-4 col-sm-12">
                <div class="resource-box">
                  <div className="resource_text">
                    <img src="assets/img/services/3.svg" className="match-img" alt="#" />
          ...
          <div className="row">
            <div className="col-lg-4 mb-5 mb-lg-0 text-center">
              ...
              <p className="text-muted">
                One stop for all your Taxation, Investment and Advisory related
                needs. Expert guidance and support on all your queries and
                issues.
              </p>
              <div className="mb-md-5 mb-4">
                <a href="#" className="btn btn-secondary btn-pill">
                  Read More
                </a>
              </div>
            </div>
              ...
              <Accordion>
                ...
                <Accordion.Item eventKey="1">
                  ...
                  <Accordion.Body>
                    ...
                    <p>
                      • To select/advice Agri-business-Government Subsidy/Grant
                      available
                    </p>
                  </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="2">
                  ...
                  <Accordion.Body>
                    ...
                    <p>• Finance against securities & immovable assets</p>
                    <p>
                      • Loans for Agricultural Business/Dairy and support in
                      getting Subsidy/Grant from Government
                    </p>
                  </Accordion.Body>
                </Accordion.Item>
