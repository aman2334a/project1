				...
				<div className="container">
					<div className="row justify-content-md-between align-items-center">
						<div class="col-md-4 text-center">
							<img src="./assets/img/services/7.svg" class="w-100 text-dark pr-5" width="50px" alt="" />
						</div>
						<div class="col-md-7">
							<div class="row">
								{/* <div class="col-md-12">
								...
								<div class="col-md-12">
									<div class="d-flex mb-md-5 rounded-md  align-items-center">
										<img src="assets/img/services/4.svg" class="display-4 text-dark pr-5" width="120px"
											alt="" />
										<div>
											<h5 class="mb-2">Mission</h5>
											<p class="text-muted">To provide excellent services in the field of Finance, Taxation, Agriculture,

												Investment and Advisory to enhance wealth. Thereafter, boosting the career opportunities overall</p>
										</div>
									</div>
								</div>
								<div class="col-md-12">
